...
variable "catalog_database_name" {
  type        = string
  default     = null
  description = "Nome do banco de dados do Glue Catalog. Se não informado, será gerado."
}

variable "name_prefix" {
  type        = string
  default     = null
  description = "Prefixo do nome do recurso se não for especificado o nome completo."
}
